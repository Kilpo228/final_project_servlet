...
@Controller
public class AmountOfIngredient implements Command {
    @InjectByType
    private IngredientService ingredientService;

    @Override
    public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        response.getWriter().write(ingredientService.getAmountOfIngredient(request.getParameter("ingredient_name")));
    }
}
